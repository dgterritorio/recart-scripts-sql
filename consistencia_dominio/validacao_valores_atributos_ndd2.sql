...
SELECT 'CONSTRUÇÕES'::text AS tema,
  ...
  FROM (public.edificio
    JOIN public.lig_valor_utilizacao_atual_edificio ON (((edificio.identificador = lig_valor_utilizacao_atual_edificio.edificio_id) AND ((lig_valor_utilizacao_atual_edificio.valor_utilizacao_atual_id)::text <> ALL (ARRAY[('1.1'::character varying)::text, ('1.2'::character varying)::text, ('2'::character varying)::text, ('3'::character varying)::text, ('4'::character varying)::text, ('5'::character varying)::text, ('6.1.1'::character varying)::text, ('6.1.2'::character varying)::text, ('6.2.1'::character varying)::text, ('6.2.2'::character varying)::text, ('6.3.1'::character varying)::text, ('6.3.2'::character varying)::text, ('6.4.2'::character varying)::text, ('6.4.3'::character varying)::text, ('6.5'::character varying)::text, ('6.6'::character varying)::text, ('7.1'::character varying)::text, ('7.2'::character varying)::text, ('7.3'::character varying)::text, ('8.1'::character varying)::text, ('8.2'::character varying)::text, ('8.3'::character varying)::text, ('8.4'::character varying)::text, ('9'::character varying)::text])))))
UNION
SELECT 'CONSTRUÇÕES'::text AS tema,
 ...
 WHERE ((ponto_interesse.valor_tipo_ponto_interesse)::text <> ALL (ARRAY[('2'::character varying)::text, ('4'::character varying)::text, ('5'::character varying)::text, ('6'::character varying)::text, ('7'::character varying)::text, ('8'::character varying)::text, ('9'::character varying)::text, ('10'::character varying)::text, ('11'::character varying)::text, ('12'::character varying)::text, ('13'::character varying)::text]))
UNION
SELECT 'CONSTRUÇÕES'::text AS tema,
...
SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
 ...
 WHERE ((cabo_electrico.valor_designacao_tensao)::text <> ALL (ARRAY[('1'::character varying)::text, ('2'::character varying)::text]))
UNION
SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
   'CaboElectrico'::text AS objeto,
   cabo_electrico.identificador AS id,
...
SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
 ...
 WHERE ((elem_assoc_telecomunicacoes.valor_elemento_associado_telecomunicacoes)::text <> '3'::text)
UNION
SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,

...
UNION
 SELECT 'CONSTRUÇÕES'::text AS tema,
  ...
  WHERE ((constru_linear.valor_construcao_linear)::text <> ALL (ARRAY[('1'::character varying)::text, ('2'::character varying)::text, ('3'::character varying)::text, ('4'::character varying)::text, ('5'::character varying)::text, ('6'::character varying)::text, ('7'::character varying)::text, ('8'::character varying)::text]))
UNION
 SELECT 'CONSTRUÇÕES'::text AS tema,
...
UNION
 SELECT 'CONSTRUÇÕES'::text AS tema,
   ...
   FROM public.edificio
  WHERE ((edificio.valor_elemento_edificio_xy)::text <> '4'::text)
UNION
 SELECT 'CONSTRUÇÕES'::text AS tema,
    'Edificio'::text AS objeto,
    edificio.identificador AS id,
...
UNION
 SELECT 'CONSTRUÇÕES'::text AS tema,
   ...
   FROM (public.edificio
     JOIN public.lig_valor_utilizacao_atual_edificio ON (((edificio.identificador = lig_valor_utilizacao_atual_edificio.edificio_id) AND ((lig_valor_utilizacao_atual_edificio.valor_utilizacao_atual_id)::text <> ALL (ARRAY[('1.1'::character varying)::text, ('1.2'::character varying)::text, ('2.1'::character varying)::text, ('2.2'::character varying)::text, ('2.3'::character varying)::text, ('3'::character varying)::text, ('4.1'::character varying)::text, ('4.2'::character varying)::text, ('4.3'::character varying)::text, ('4.4'::character varying)::text, ('5.1'::character varying)::text, ('5.2'::character varying)::text, ('5.3'::character varying)::text, ('6.1.1'::character varying)::text, ('6.1.2'::character varying)::text, ('6.2.1'::character varying)::text, ('6.2.2'::character varying)::text, ('6.3.1'::character varying)::text, ('6.3.2'::character varying)::text, ('6.4.1'::character varying)::text, ('6.4.2'::character varying)::text, ('6.4.3'::character varying)::text, ('6.5'::character varying)::text, ('6.6'::character varying)::text, ('7.1'::character varying)::text, ('7.2'::character varying)::text, ('7.3'::character varying)::text, ('8.1'::character varying)::text, ('8.2'::character varying)::text, ('8.3'::character varying)::text, ('8.4'::character varying)::text, ('9'::character varying)::text])))))
UNION
 SELECT 'CONSTRUÇÕES'::text AS tema,
...
UNION
 SELECT 'HIDROGRAFIA'::text AS tema,
  ...
  WHERE ((agua_lentica.valor_agua_lentica)::text <> ALL (ARRAY[('1'::character varying)::text, ('2'::character varying)::text, ('3'::character varying)::text]))
UNION
 SELECT 'HIDROGRAFIA'::text AS tema,
...
UNION
 SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
  ...
  WHERE ((elem_assoc_eletricidade.valor_elemento_associado_electricidade)::text <> ALL (ARRAY[('1.1'::character varying)::text, ('1.2'::character varying)::text, ('1.4'::character varying)::text, ('2'::character varying)::text, ('3'::character varying)::text, ('4'::character varying)::text, ('5'::character varying)::text, ('6.1'::character varying)::text, ('6.2'::character varying)::text, ('7.1'::character varying)::text, ('7.2'::character varying)::text, ('7.3'::character varying)::text, ('7.4'::character varying)::text, ('8'::character varying)::text, ('9'::character varying)::text]))
UNION
 SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
...
UNION
 SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
  ...
  WHERE ((elem_assoc_telecomunicacoes.valor_elemento_associado_telecomunicacoes)::text <> ALL (ARRAY[('1'::character varying)::text, ('3'::character varying)::text]))
UNION
 SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
...
UNION
 SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
  ...
  WHERE ((inst_producao.valor_instalacao_producao)::text <> ALL (ARRAY[('1.1'::character varying)::text, ('1.2'::character varying)::text, ('1.3'::character varying)::text, ('1.4'::character varying)::text, ('2'::character varying)::text, ('3'::character varying)::text, ('4.1'::character varying)::text, ('4.2'::character varying)::text, ('4.4'::character varying)::text, ('5'::character varying)::text, ('6'::character varying)::text, ('7.1'::character varying)::text, ('7.2'::character varying)::text, ('7.3'::character varying)::text, ('8'::character varying)::text, ('9'::character varying)::text, ('10'::character varying)::text, ('11'::character varying)::text, ('12'::character varying)::text]))
UNION
 SELECT 'INFRAESTRUTURAS E SERVIÇOS DE INTERESSE PÚBLICO'::text AS tema,
...
UNION
 SELECT 'TOPONÍMIA'::text AS tema,
  ...
  WHERE ((designacao_local.valor_local_nomeado)::text <> ALL (ARRAY[('3'::character varying)::text, ('4'::character varying)::text, ('5'::character varying)::text, ('6.2'::character varying)::text, ('6.3'::character varying)::text, ('6.4'::character varying)::text, ('6.5'::character varying)::text, ('6.6'::character varying)::text, ('6.7'::character varying)::text, ('6.8'::character varying)::text, ('6.9'::character varying)::text, ('6.10'::character varying)::text, ('7.1'::character varying)::text, ('7.2'::character varying)::text, ('7.3'::character varying)::text, ('8'::character varying)::text, ('9'::character varying)::text, ('10'::character varying)::text, ('11'::character varying)::text, ('12'::character varying)::text, ('13'::character varying)::text, ('14'::character varying)::text, ('15'::character varying)::text]))
UNION
